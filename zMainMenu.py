...
window = Tk()
window.geometry('385x466')
window.title("Car store management.")

icon = PhotoImage(file = icon_file_path)
window.iconphoto(True,icon)

title_label = Label(window,text='CARSTORE MANAGEMENT PROGRAM',font=("Calibri",17,'bold'))
...
button = Button(button_frame, text="Car storage list",font=("Arial",15),relief=RAISED,bd=5, 
                width=20, height=3,fg="white",bg="#1A237E",command=carstore_edit)
button.grid(row=0, column=0)

button2 = Button(button_frame, text="Customer list",font=("Arial",15),relief=RAISED,bd=5, 
                width=20, height=3,fg="white",bg="#1A237E", command=customer_manager)
button2.grid(row=1, column=0)

button1 = Button(button_frame, text="Buy a car ",font=("Arial",15),relief=RAISED,bd=5, 
                width=20, height=3,fg="white",bg="#1A237E",command=Receipt_manage)
button1.grid(row=2, column=0)

button3 = Button(button_frame, text="Receipt list ",font=("Arial",15),relief=RAISED,bd=5, 
